...
class TrajectorySummaryPanel(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        ctk.CTkLabel(
            self.details_grid, text="Jump Takeoffs:", font=key_font, text_color="#aaaaaa"
        ...
        ctk.CTkLabel(
            self.details_grid, text="Confidence:", font=key_font, text_color="#aaaaaa"
        ...
        ctk.CTkLabel(
            self.details_grid, text="Kind:", font=key_font, text_color="#aaaaaa"
    ...
    def update_summary(self, trajectory):
        ...
        if isinstance(confidence, (int, float)):
            self.confidence_val.configure(text=f"{float(confidence):.3f}")
        else:
            self.confidence_val.configure(text="N/A")

        kind = getattr(trajectory, "kind", None) or "train"
        self.kind_val.configure(text=str(kind))
